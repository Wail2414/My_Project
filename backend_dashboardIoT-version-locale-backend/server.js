...
const clientStackRoutes = require("./routes/clientStackRoutes");
...
app.use("/api/client-stacks", clientStackRoutes);
...
sequelize
  ...
  .then(async () => {
    ...
    /*server.listen(PORT, () => {
      console.log(
        `✅ HTTPS + WebSocket server running on https://localhost:${PORT}`
      );
    });*/
  })
  .catch((error) => {
